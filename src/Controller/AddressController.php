...
class AddressController extends AbstractDoctrineController
{
    ...
    public function viewAction()
    {
        ...
        $entity = $this->getObjectManager()->getRepository(Address::class)->findOneBy(['id' => $identifier]);
    ...
    public function addAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirectToRoute('addresses/view', ['id' => $entity->getId()]);
            }
        }
